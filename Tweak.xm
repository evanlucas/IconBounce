...
#define PREFS_CHANGED_NOTIFICATION "com.curapps.iconbounce.prefschanged"
...
#define IBLog(fmt, ...) \
  if (debug)            \
    NSLog((@"IconBounce [DEBUG] - " fmt), ##__VA_ARGS__);
...
- (void)startBouncing;
- (void)performBounceForIconView:(SBIconView *)iv
...
- (void)setAnchorPoint:(CGPoint)anchorPoint forView:(UIView *)view {
  ...
  CGPoint newPoint = CGPointMake(bounds.size.width * anchorPoint.x,
                                 bounds.size.height * anchorPoint.y);
  CGPoint oldPoint = CGPointMake(bounds.size.width * view.layer.anchorPoint.x,
                                 bounds.size.height * view.layer.anchorPoint.y);
...
static void CreateSettings() {
  ...
  NSArray *allAnimations = [[NSMutableArray alloc] initWithObjects:
    [NSDictionary dictionaryWithObjectsAndKeys:@"RotateClockwise",
      @"key", @"Rotate Clockwise", @"title", nil],
    [NSDictionary dictionaryWithObjectsAndKeys:@"RotateCounterClockwise",
      @"key", @"Rotate Counter Clockwise", @"title", nil],
    [NSDictionary dictionaryWithObjectsAndKeys:@"FlipHorizontal",
      @"key", @"Flip Horizontal", @"title", nil],
    [NSDictionary dictionaryWithObjectsAndKeys:@"FlipVertical",
      @"key", @"Flip Vertical", @"title", nil],
    [NSDictionary dictionaryWithObjectsAndKeys:@"Bounce",
      @"key", @"Bounce", @"title", nil],
    [NSDictionary dictionaryWithObjectsAndKeys:@"RotateFlipAndBounce",
      @"key", @"Rotate, Flip, and Bounce", @"title", nil],
    nil];
  ...
  [d writeToFile:PREFS_PATH atomically:YES];
}
...
__attribute__((constructor)) static void ib_init() {
  ...
  CFNotificationCenterAddObserver(CFNotificationCenterGetDarwinNotifyCenter(),
                                  NULL,
                                  (void (*)(CFNotificationCenterRef, void *, CFStringRef, const void *, CFDictionaryRef))LoadSettings,
                                  CFSTR(PREFS_CHANGED_NOTIFICATION),
                                  NULL,
                                  CFNotificationSuspensionBehaviorCoalesce);
  CFNotificationCenterAddObserver(CFNotificationCenterGetDarwinNotifyCenter(),
                                  NULL,
                                  (void (*)(CFNotificationCenterRef, void *, CFStringRef, const void *, CFDictionaryRef))ReloadSettings,
                                  CFSTR("com.curapps.prefschanged"),
                                  NULL,
                                  CFNotificationSuspensionBehaviorCoalesce);
	[pool drain];
}
